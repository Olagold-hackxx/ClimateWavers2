...
async def fetch_disasters_climate_data() -> bool:
    ...
    for disaster in disaster_types:
        ...
        climate_dataset_df.to_csv("dataset/climate_data/" + disaster + "_climate_data.csv", index=False)
        ...
        for index, row in df.iterrows():
            ...
            climate_dataset_df.to_csv('dataset/climate_data/' + disaster + "_climate_data.csv", mode='a', header=False, index=False)
